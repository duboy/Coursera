...
class Warrior {
	...
	public:
		...
		void process (string side) {
			cout << ' ' + side;
			if ( side == "red" ){
				cout << ' ' + name + ' ' << ++redNum << " born with strength " << hp << "," << ++num << " " + name + " in ";
				cout << side + " headquarter" << endl;
			}
			if ( side == "blue" ) {
				cout << ' ' + name + ' ' << ++bluNum << " born with strength " << hp << "," << ++num << " " + name + " in ";
				cout << side + " headquarter" << endl;
			}
		}
};
